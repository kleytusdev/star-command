<nav
    ...
    class="top-0 z-10 flex items-center justify-between px-4 py-4 sm:px-6 duration-500 bg-gray-100 dark:bg-dark-eval-1"
>
    ...
    <div class="flex items-center gap-3">
        ...
        <x-dropdown align="right" width="48">
            <x-slot name="trigger">
                ...
                >
                    <div>{{ ucwords(strtolower(Auth::user()->person->name)) }}</div>
